                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                  ...
                  {sessionDetails[session.id].ai_analysis && (() => {
                    ...
                    try {
                      ...
                      return <div className="mt-4 p-3 bg-red-900/30 rounded-lg text-sm text-red-400">Blad parsowania analizy</div>;
                    }
                      ...
                      <div className="mt-4 space-y-3">
                        ...
                        <div className="p-3 rounded-lg bg-primary-900/30">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm font-medium text-primary-400">Analiza</span>
                          </div>
